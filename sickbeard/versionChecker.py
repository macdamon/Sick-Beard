    ...
    def update(self):
        ...
        try:
            ...
            try:
                ...
                data = urllib2.urlopen(zip_download_url)
            ...
            zip_download_path = os.path.join(sb_update_dir, download_name)

            # save to disk
            f = open(zip_download_path, 'wb')
            f.write(data.read())
            f.close()
...
class SourceUpdateManager(GitUpdateManager):
    ...
    def update(self):
        ...
        try:
            ...
            download_name = data.geturl().split('/')[-1]
            tar_download_path = os.path.join(sb_update_dir, download_name)
